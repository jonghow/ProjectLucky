...
namespace EntityBehaviorTree
{
    // MealFactory 전용 ActionNode Space 입니다.

    public class MealFactoryCreateEntity : BTActionStrategy
    {
        private EntityMealFactoryController _m_CachedOwnerController;
        public long _ml_ownerUID;
        public int _mi_ownerJobID;

        public MealFactoryCreateEntity(long _ownerUID)
        {
            // 평타는 보통 타겟을 정해서 발사한다.
            this._ml_ownerUID = _ownerUID;
            ...
            _mi_ownerJobID = _entity.JobID;
        }
        public BTNodeState Run()
        {
            _m_CachedOwnerController.CreateMealKitMercenaryEntity();
            return BTNodeState.Failure;
        }
    ...
    public class StoreFactoryCreateEntity : BTActionStrategy
    {
        private EntityStoreFactoryController _m_CachedOwnerController;
        public long _ml_ownerUID;
        public int _mi_ownerJobID;

        public StoreFactoryCreateEntity(long _ownerUID)
        {
            // 평타는 보통 타겟을 정해서 발사한다.
            this._ml_ownerUID = _ownerUID;
